...
SWIFT_MODULE_NAMESPACE_PUSH("Presentr")
@class NSBundle;
@class NSCoder;
...
- (nonnull instancetype)initFromRight:(BOOL)fromRight OBJC_DESIGNATED_INITIALIZER;
- (CGRect)transformWithContainerFrame:(CGRect)containerFrame finalFrame:(CGRect)finalFrame SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, strong) UIView * _Nullable customBackgroundView;
...
@property (nonatomic) BOOL shouldIgnoreTapOutsideContext;
/// Uses the ViewController’s frame as context for the presentation. Imitates UIModalPresentation.currentContext
@property (nonatomic, weak) UIViewController * _Nullable viewControllerForContext;
...
+ (AlertViewController * _Nonnull)alertViewControllerWithTitle:(NSString * _Nonnull)title body:(NSString * _Nonnull)body SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
